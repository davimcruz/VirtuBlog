...
const RightSection = () => {
  return (
    <div className="flex-col rounded-lg shadow-xl">
      ...
      <div className="relative flex flex-col h-full px-6 md:p-6 my-12 pb-12">
        <h1 className="text-zinc-900 text-xl font-bold">
        ...
        <div className="flex justify-center my-6 relative">
          <Image
            ...
            alt="PUC Goiás Campus V"
            width={1920}
            height={1080}
            className="md:w-[90%] md:h-[80%] rounded-lg mt-4 blur-sm"
          />
          <div className="absolute inset-0 flex items-center justify-center">
            <p className="text-white text-center text-md font-semibold md:font-bold">
